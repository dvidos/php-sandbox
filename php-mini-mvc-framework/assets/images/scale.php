...
/* 
	rescales images so they appear in the requested size
	call using parameters:
	src="xxx", where xxx a relative path, or an http url
	width=000, the desired width, if any
	height=000, the desired height if any
*/

$s = new ImageScaler();
$s->show(@$_REQUEST['src'], @$_REQUEST['width'], @$_REQUEST['height']);
